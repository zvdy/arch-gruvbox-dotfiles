...
# make an alias to execute .local/share/bin/swwwallpaper.sh -s $1 where $1 is the path to the image
alias setwall=".local/share/bin/swwwallpaper.sh -s"
...
#set wallpaper, taking path as argument
alias setwall=".local/share/bin/swwwallpaper.sh -s"
...
export PATH=$PATH:/home/zvdy/.spicetify
